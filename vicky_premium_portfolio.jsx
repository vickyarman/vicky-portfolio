      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            ...
            className="ml-2 inline-flex items-center rounded-full bg-violet-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-violet-500"
          >
      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <a
              href="#work"
              className="inline-flex items-center justify-center rounded-full bg-violet-600 px-6 py-3.5 font-medium text-white transition hover:bg-violet-500"
            >
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center rounded-full bg-white px-4 py-2.5 text-sm font-medium text-black transition hover:bg-slate-200"
                    >
                      <PlayIcon className="mr-2 h-4 w-4" /> Watch Portfolio
                    </a>
                    <a
                      href="#contact"
                      className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-white/10"
                    >
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {services.map((service) => (
          <motion.div key={service.title} whileHover={{ y: -6 }}>
            <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl transition hover:border-violet-400/30 hover:bg-white/[0.07]">
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {projects.map((project) => (
          <motion.div key={project.title} whileHover={{ y: -8 }}>
            <div className="group h-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 backdrop-blur-xl">
    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-2">
        {testimonials.map((item) => (
          <div key={item.name} className="rounded-[1.5rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl md:p-8">
  ...
  return (
    <section id="contact" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-violet-600/15 via-white/5 to-cyan-500/10 p-6 backdrop-blur-xl md:p-8">
