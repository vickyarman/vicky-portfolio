  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-black/30 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <div>
          <p className="text-sm uppercase tracking-[0.35em] text-white">Vicky Arman</p>
          <p className="text-xs text-white">AI Video Editor • Motion Graphics</p>
        </div>
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                      <Button asChild size="sm" className="rounded-full bg-violet-600 px-4 text-white hover:bg-violet-500">
                        <a href={portfolioUrl} target="_blank" rel="noopener noreferrer">
          ...
          <motion.div key={service.title} whileHover={{ y: -6 }}>
            <Card className="h-full border-white/10 bg-white/5 backdrop-blur-xl transition hover:border-violet-400/30 hover:bg-white/[0.07]">
              <CardContent className="p-6">
                ...
                <p className="mt-3 text-sm leading-7 text-white">{service.desc}</p>
              </CardContent>
            </Card>
          </motion.div>
        ))}
